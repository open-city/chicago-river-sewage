...
UPDATED_SEGMENTS = {
    ...
    "Addison Cr": 23
    # 30, 31, and 32 follow different rules, not sure about 31 overall, and haven't seen any examples for 32 O'Brien
}
...
if __name__ == '__main__':
    ...
    #scrape_table(date_today, date_today)
    scrape_table('01/01/2016', date_today)
